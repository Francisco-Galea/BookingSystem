namespace Booking.Models.Entities
{
    public class ElectronicEntity : RentableEntity
    {
        ...
        public ElectronicEntity(string BRAND, string MODEL, string SERIALNUMBER, string NAME, string DESCRIPTION, decimal MAINTENANCECOSTPERDAY, decimal COSTUSAGERPERDAY ) : base(NAME, DESCRIPTION, MAINTENANCECOSTPERDAY, COSTUSAGERPERDAY)
        {
            this.Brand = BRAND;
            this.Model = MODEL;
