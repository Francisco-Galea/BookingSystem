...
namespace Booking.Models.Entities
{
    public class HouseholdApplianceEntity : RentableEntity
    {
        ...
        public HouseholdApplianceEntity(string BRAND, string MODEL, string SERIALNUMBER, string USAGETYPE, string NAME, string DESCRIPTION, decimal MAINTENANCECOSTPERDAY, decimal COSTUSAGERPERDAY) : base(NAME, DESCRIPTION, MAINTENANCECOSTPERDAY, COSTUSAGERPERDAY)
        {
            this.Brand = BRAND;
            this.Model = MODEL;
