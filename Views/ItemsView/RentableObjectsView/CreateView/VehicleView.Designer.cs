namespace Boocking.Views.RentableObjectsView
{
    partial class VehicleView
    {
        ...
        private void InitializeComponent()
        {
            ...
            PassengerCapacity = new DataGridViewTextBoxColumn();
            CostUsagePerDay = new DataGridViewTextBoxColumn();
            ...
            dgvVehicles.Columns.AddRange(new DataGridViewColumn[] { rentableId, name, Brand, Model, PassengerCapacity, CostUsagePerDay, Description, SerialNumber });
            dgvVehicles.Location = new Point(168, 7);
            dgvVehicles.Margin = new Padding(2);
            dgvVehicles.Name = "dgvVehicles";
            dgvVehicles.RowHeadersWidth = 62;
            dgvVehicles.Size = new Size(1067, 465);
            dgvVehicles.TabIndex = 22;
            // 
            // btnBack
            // 
            btnBack.Location = new Point(1141, 476);
            ...
            // PassengerCapacity
            // 
            PassengerCapacity.HeaderText = "Capacidad de pasajeros";
            PassengerCapacity.MinimumWidth = 6;
            PassengerCapacity.Name = "PassengerCapacity";
            PassengerCapacity.Width = 125;
            // 
            // CostUsagePerDay
            // 
            CostUsagePerDay.HeaderText = "Tarifa diaria";
            CostUsagePerDay.MinimumWidth = 6;
            CostUsagePerDay.Name = "CostUsagePerDay";
            CostUsagePerDay.Width = 125;
            // 
            // Description
            // 
        ...
        private DataGridViewTextBoxColumn CostUsagePerDay;
